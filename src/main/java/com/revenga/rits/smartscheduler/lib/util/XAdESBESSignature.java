...
public class XAdESBESSignature extends GenericXMLSignature {
	...
	public static synchronized void firmar(String xmlPath, String pathSignature, String passSignature, String pathOut,
			String nameFileOut) throws CertificateException, IOException {
